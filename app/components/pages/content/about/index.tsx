      ...
      <div className="About__content">
        ...
        <div>
          ...
          <p>
            ...
            coupled with a strong eye towards competent UX & UIs. In my previous
            roles, I regularly contributed towards the definition of the schema,
            endpoints and payloads of the APIs alongside the backend engineers
            of my teams. My experiences have also provided me with valuable
            respect towards the principles of CI/CD too.
          </p>
          <p>
            I constantly keep up to date with the latest technologies by reading
            engineering blogs of my favourite apps/software and I am always
          ...
          <p>
            ...
            using it more for Youtube nowadays 🙈). I also enjoy travelling (30+
            countries so far) mainly for food tasting and experiencing different
